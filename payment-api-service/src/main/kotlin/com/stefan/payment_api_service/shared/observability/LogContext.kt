...
object LogContext {
     ...
     *
     * The key gets checked too, not just the header. Whatever comes back from here
     * is written to a correlation_id column that only holds 64 characters, so an
     * odd key would fail the insert and cost us the event.
     */
